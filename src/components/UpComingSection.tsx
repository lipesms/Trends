...
const UpComingSection = ({ title }: UpComingProps) => {
  ...
  if (data) {
    return (
      <section className=" w-90 pt-4 pb-8 flex flex-col items-center drop-shadow-xl lg:items-start md:pt-10 lg:h-fit xl:pe-8 xl:ps-14">
        <div className="overflow-hidden relative z-10 p-6 pb-12 h-full rounded-3xl">
