...
const Footer = () => (
  <footer className="relative mt-28 px-8 pb-14 md:ps-14">
    <div className="max-w-618">
      <p className="text-white  mb-1 md:text-lg ">
      ...
      <p className="text-white mb-1 md:text-lg ">
        &quot;Este produto usa a API TMDB, mas não é endossado ou certificado
        pelo TMDB&quot;
      </p>
      <img className="max-w-52 md:max-w-80 mt-8" src={logoTMDB} alt="" />
      <img
        className="absolute bottom-14 right-10 max-w-10 md:max-w-20 hover:pb-2 transition-all easy-out duration-200 cursor-pointer"
        src={up}
        alt=""
      />
    </div>
